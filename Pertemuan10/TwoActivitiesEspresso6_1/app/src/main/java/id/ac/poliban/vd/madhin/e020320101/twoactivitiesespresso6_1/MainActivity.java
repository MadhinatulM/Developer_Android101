package id.ac.poliban.vd.madhin.e020320101.twoactivitiesespresso6_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.vd.madhin.e020320101.twoactivitiesespresso6_1.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Two Activities Espresso Test_Madhin");
