package id.ac.poliban.mi.vd.madhin.notifyme_madhin;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.vd.madhin.notifyme_madhin.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("NotifyMe! Madhin");
